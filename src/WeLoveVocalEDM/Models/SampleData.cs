...
namespace WeLoveVocalEDM.Models
{
    public class SampleData
    {
        ...
        public static async Task InitializeWeLoveVocalEDMDatabaseAsync(IServiceProvider serviceProvider, bool createUsers = true)
        {
            using (var serviceScope = serviceProvider.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                var db = serviceScope.ServiceProvider.GetService<WeLoveVocalEDMContext>();
