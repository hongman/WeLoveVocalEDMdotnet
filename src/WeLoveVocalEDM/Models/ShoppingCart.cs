...
namespace WeLoveVocalEDM.Models
{
    ...
    {
        private readonly WeLoveVocalEDMContext _dbContext;
        private readonly string _shoppingCartId;

        private ShoppingCart(WeLoveVocalEDMContext dbContext, string id)
        {
            _dbContext = dbContext;
            _shoppingCartId = id;
        }

        public static ShoppingCart GetCart(WeLoveVocalEDMContext db, HttpContext context)
            => GetCart(db, GetCartId(context));

        public static ShoppingCart GetCart(WeLoveVocalEDMContext db, string cartId)
